...
void insertionAtHead(Node* &head , Node* &tail  , int d){
    ...
    Node *copyList(Node *head)
    {
        ...
        Node* cloneTail = NULL;
         ...
         Node* temp = head;
         while(temp!=NULL){
             insertionAtHead(cloneHead , cloneTail , temp->data);
             temp = temp->next;
         }
         
         // step2- cloneNode add in between in originalNode 
         Node* originalNode =  head;
         Node* cloneNode = cloneHead;
         
        //  Node* head1= originalNode->next;
         ...
         // step4-  reverse the process of step 2 
          originalNode = head;
          cloneNode = cloneHead;
